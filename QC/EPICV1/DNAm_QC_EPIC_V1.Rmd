...
Q1 <- quantile(normv$rmsd, 0.25)
Q3 <- quantile(normv$rmsd, 0.75)
...
The 'qual' function in the wateRmelon package can be used to assess the degree of difference between normalised and raw betas. Those samples with Root Mean Square Deviation (RMSD) > `r threshold` will be filter out.

```{r qual, echo = FALSE}

plot(normv[,1:2], main = "Normalisation Violence")
boxplot(qual_df$rmsd, main = "Normalisation Violence", ylab = "rmsd")
