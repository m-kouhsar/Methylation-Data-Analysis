...
IntensityThreshold=as.numeric(args[6])
...
if(all(tolower(Organ)=="blood")){
  ...
  counts <- estimateCellCounts(RGset, compositeCellType ="Blood", cellTypes = c("CD8T","CD4T", "NK","Bcell","Mono","Gran"), processMethod = "auto")
  flag = T
  ...
  counts <- estimateCellCounts(RGset, compositeCellType ="DLPFC",cellTypes=c("NeuN_neg" ,"NeuN_pos"))
  flag=T
  save(counts, file=paste0(OutPrefix,".CellCounts.rdat"))
  message("CellCount created and saved in ", paste0(OutPrefix,".CellCounts.rdat"))
  ...
  counts <- estimateCellCounts(RGset, compositeCellType ="CordBlood",cellTypes=c("Bcell", "CD4T", "CD8T", "Gran", "Mono", "Neu", "nRBC"))
  flag=T
  save(counts, file=paste0(OutPrefix,".CellCounts.rdat"))
  message("CellCount created and saved in ", paste0(OutPrefix,".CellCounts.rdat"))
